...
|--------------|-------------------|-------------|
| Offensive Security Automation | <a href="https://github.com/larryklingaman3/shimada/blob/main/README.md">Shimada</a> | Developed a Python tool to automatically enumerate and exploit common Active Directory vulnerabilities and created a vulnerable AD environment to test and validate the script’s functionality. |

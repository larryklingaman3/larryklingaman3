...
|-----------------------------------------------|----------------------------|--------------------| 
| Python | <a href="https://github.com/larryklingaman3/shimada">shimada | Created a Python program to automatically enumerate and exploit common Active Directory vulnerabilities.
